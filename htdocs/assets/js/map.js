...
function setData(){
  ...
  data = {
    ...
    traffic1: { cat: "land", title: "到達エリア面積の~1時間重心地", text: "到達エリア面積~1時間の重心地", min: 0.03, max: 0.47, latSum: 0, lngSum: 0, sum: 0 },
    traffic5: { cat: "land", title: "到達エリア面積の~5時間重心地", text: "到達エリア面積~5時間の重心地", min: 7.01, max: 37.11, latSum: 0, lngSum: 0, sum: 0 },
    traffic10: { cat: "land", title: "到達エリア面積の~10時間重心地", text: "到達エリア面積~10時間の重心地", min: 77.03, max: 98.39, latSum: 0, lngSum: 0, sum: 0 },
    ...
    museum: { cat: "culture", title: "人口100万人当たりの博物館数指標値の重心地", text: "博物館数の重心地", min: 3.5, max: 37.3, latSum: 0, lngSum: 0, sum: 0 },
    ...
    finallandfill: { cat: "culture", title: "最終処分場残余容量の重心地", text: "最終処分場残余容量の重心地", min: 0, max: 23571, latSum: 0, lngSum: 0, sum: 0 },
    // retailstore: { cat: "store", title: "小売店数（人口千人当たり）の重心地", text: "小売店数の重心地", min: 5.74, max: 11.13, latSum: 0, lngSum: 0, sum: 0 },
    foodstore: { cat: "store", title: "食品スーパーマーケットの重心地", text: "食品スーパーマーケット数の重心地", min: 90, max: 2394, latSum: 0, lngSum: 0, sum: 0 },
    ...
    savings: { cat: "culture", title: "貯蓄現在高（１世帯当たり）の重心地", text: "貯蓄現在高の重心地", min: 5747, max: 19669, latSum: 0, lngSum: 0, sum: 0 },
